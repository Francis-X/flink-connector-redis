...
public class FlinkLettuceClusterConfig extends FlinkRedisConfigBase {
    ...
    protected FlinkLettuceClusterConfig(int maxTotal, int maxIdle, int minIdle, long connectionTimeout, String password, int maxRedirects, Set<InetSocketAddress> nodes, int database) {
        super(maxTotal, maxIdle, minIdle, connectionTimeout, password, database);
        this.maxRedirects = maxRedirects;
        this.nodes = nodes;
    }

    protected FlinkLettuceClusterConfig(Builder builder) {
